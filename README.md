# CONDENSEDORDERS FOR [DOLIBARR ERP & CRM](https://www.dolibarr.org)
...
Clone the repository in `$dolibarr_main_document_root_alt/condensedorders`

```shell
cd ....../custom
git clone git@github.com:gitlogin/condensedorders.git condensedorders
```
